...
def train_model(
    ...
    datasets = [
        BasicDataset('./data/cvl/trainset/source/computer', './data/cvl/trainset/gt/computer', img_scale),
        AugmentedDataset('./data/cvl/trainset/source/computer', './data/cvl/trainset/gt/computer', img_scale, transforms),
        BasicDataset('./data/cvl/trainset/source/handwritten', './data/cvl/trainset/gt/handwritten', img_scale),
    ...
    scheduler = optim.lr_scheduler.CyclicLR(optimizer, max_lr=learning_rate*10, step_size_up=n_train//2,
                                            base_lr=learning_rate, cycle_momentum=False,
                                            scale_fn=lambda x: cyclic_lr_scale_fn(x, -0.4, epochs//2))

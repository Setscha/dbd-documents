...
def train_model(
    ...
    # (Initialize logging)
    experiment = wandb.init(project='DBD-Documents', resume='allow', anonymous='allow', mode="online", name=os.environ['RUN_ID'])
    ...
    for epoch in range(1, epochs + 1):
        ...
        if save_checkpoint:
            ...
            torch.save(state_dict, str(dir_checkpoint / f'{os.environ["RUN_ID"]}_checkpoint_epoch{epoch}.pth'))
